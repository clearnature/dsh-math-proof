...
| 六十一 | fable5 是流程而非纯知识 | 查证上游全历史只有 README+SKILL.md（无 hooks）；九步闭环里能拦截的两步由本项目新钩子 `hooks/fable5-flow.mjs` 承担（UserPromptSubmit 开工四项 / Stop 收工三项，短问句与纯应答不打扰），其余映射到既有关卡；文档与署名明确「钩子非上游提供」 |
